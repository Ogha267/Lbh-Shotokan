                               ...
                               <tbody>
                                   ...
                                   <?php foreach ($list_input as $lu) : ?>
                                       <tr>
                                           ...
                                           <td><a href="<?php echo base_url('user/download_input/') . $lu['id_input']; ?>" class="btn btn-info btn-block btn-sm"><i class="fas fa-download"></i> Download</a> </td>
                                       </tr>
                                   <?php endforeach; ?>
                               </tbody>
                           </table>
   ...
   <div class="modal fade" id="edit-user">
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="box-body">
                       <?php echo form_open_multipart('user/edit_input'); ?>
                       <div class="form-group">
                           <label>Tgl Upload</label>
   ...
   <script>
       $('.tombol-edit').on('click', function() {
           ...
           $.ajax({
               url: '<?php echo base_url('user/get_input'); ?>',
               data: {
                   id_input: id_input
               },
               method: 'post',
