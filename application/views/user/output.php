                               ...
                               <tbody>
                                   ...
                                   <?php foreach ($list_output as $lu) : ?>
                                       <tr>
                                           ...
                                           <td><a href="<?php echo base_url('user/download_output/') . $lu['id_output']; ?>" class="btn btn-info btn-block btn-sm"><i class="fas fa-download"></i> Download</a> </td>
                                       </tr>
                                   <?php endforeach; ?>
                               </tbody>
                           </table>
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="box-body">
                       <?php echo form_open_multipart('user/output'); ?>
   ...
   <div class="modal fade" id="edit-user">
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="box-body">
                       <?php echo form_open_multipart('user/edit_output'); ?>
                       <div class="form-group">
                           <label>Tgl Upload</label>
   ...
   <script>
       $('.tombol-edit').on('click', function() {
           ...
           $.ajax({
               url: '<?php echo base_url('user/get_output'); ?>',
               data: {
                   id_output: id_output
               },
               method: 'post',
