        ...
        <ul class="navbar-nav bg-gray-600 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('user/files'); ?>">Dokumen File</a>
                        <a class="collapse-item" href="<?php echo base_url('user/scan'); ?>">Scan Berkas</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                        <a class="collapse-item" href="<?php echo base_url('user/input'); ?>">Dokumen Input</a>
                        <a class="collapse-item" href="<?php echo base_url('user/output'); ?>">Dokumen Output</a>
