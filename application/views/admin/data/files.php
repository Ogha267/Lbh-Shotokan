                               ...
                               <tbody>
                                   ...
                                   <?php foreach ($list_file as $lu) : ?>
                                       <tr>
                                           ...
                                           <td><a href="<?php echo base_url('admin/download/') . $lu['id_file']; ?>" class="btn btn-info btn-block btn-sm"><i class="fas fa-download"></i> Download</a> </td>
                                       </tr>
                                   <?php endforeach; ?>
                               </tbody>
                           </table>
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="box-body">
                       <?php echo form_open_multipart('admin/files'); ?>
   ...
   <div class="modal fade" id="edit-user">
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="box-body">
                       <?php echo form_open_multipart('admin/edit_file'); ?>
                       <div class="form-group">
                           <label>Tgl Upload</label>
   ...
   <script>
       $('.tombol-edit').on('click', function() {
           ...
           $.ajax({
               url: '<?php echo base_url('admin/get_file'); ?>',
               data: {
                   id_file: id_file
               },
               method: 'post',
